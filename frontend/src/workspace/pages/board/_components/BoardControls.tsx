...
export function BoardTabs({ tabs, activeBoardId, readOnly, onSelectBoard, onCreateBoard, }: {
    ...
    return (<div className="analysis-board-toolbar analysis-board-toolbar-direct workflow-shell-card">
