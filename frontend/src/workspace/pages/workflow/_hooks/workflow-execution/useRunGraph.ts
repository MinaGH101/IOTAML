...
export function useRunGraph(o: WorkflowExecutionOptions) { return useCallback(async (nodeId: string | null) => { if (o.versionPreviewActive) {
    ...
    return;
} const edges = normalizeEdgeHandles(o.nodes, o.edges); if (nodeId) {
    ...
    o.setBusy(false);
} }, [o.autosaveSignature, o.autosaveSnapshot, o.componentEditorActive, o.currentOutputSignature, o.datasetId, o.edges, o.nodes, o.persistSnapshot, o.projectId, o.recordRun, o.setBusy, o.setLastRunSignature, o.setMessage, o.setSelectedEdgeId, o.setSelectedEdgeIds, o.setSelectedId, o.setSelectedIds, o.targetColumn, o.taskType, o.versionPreviewActive, o.workflowName]); }
