...
export function useBoardDialogs({ activeBoard, readOnly, renameBoard, removeBoard, }: {
    ...
    const confirmDelete = useCallback(() => {
        if (!activeBoard || activeBoard.id === MAIN_ANALYSIS_BOARD_ID)
            return;
