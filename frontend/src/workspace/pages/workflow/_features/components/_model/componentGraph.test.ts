...
import type { ComponentVersion, RegistryNode, WorkflowComponent } from '../../../../../../shared/types';
...
test('component expansion restores internal nodes and reconnects external edges', () => {
    ...
    assert.equal((expanded.expandedNodes[0].data.params as Record<string, unknown>).value, 3);
});
