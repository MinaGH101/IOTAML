...
import type { RegistryNode, UserProfile, WorkflowComponent, ComponentVersion } from '../../../../../../shared/_types';
...
export type FitView = (options: { padding?: number; duration?: number; nodes?: Node[] }) => unknown;
