...
/**
 * Compatibility facade for callers outside workspace.
 * Workspace code imports domain APIs directly; remove this file after external callers migrate.
 */
export const workspaceApi = {
    ...
    assistantHistory: assistantApi.history,
    clearAssistantHistory: assistantApi.clearHistory,
};
