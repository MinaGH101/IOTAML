...
export function registryForFlowNode(node: Node | undefined, registry: RegistryNode[], aliases: LegacyNodeAliases): RegistryNode | null {
    if (!node)
        return null;
...
export function portTypeFor(node: Node | undefined, registry: RegistryNode[], aliases: LegacyNodeAliases, handle: string | null | undefined, side: 'source' | 'target'): string {
...
export function compatiblePorts(sourceType: string, targetType: string, compatibility: PortCompatibilityMap): boolean {
