...
export function ParamEditor({ selectedNode, registry, aliases, datasets, availableColumns, availableIdColumns = [], inheritedIdColumn = null, availableRows = [], onParamsChange, onRename }: ParamEditorProps) {
