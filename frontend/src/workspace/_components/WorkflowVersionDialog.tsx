...
export function WorkflowVersionDialog({ open, defaultName, busy, onClose, onSave }: WorkflowVersionDialogProps) {
    ...
    return (<AppDialog open={open} title="ذخیره نسخه جریان" description="این نسخه ثابت و قابل بازیابی است. ذخیره خودکار همچنان نسخه جاری را نگهداری می‌کند." onClose={onClose} closeDisabled={busy} footer={<>
