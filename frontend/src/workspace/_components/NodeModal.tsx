...
export function NodeModal({ node, workflowNodes, edges, registry, aliases, portCompatibility, datasets, availableColumns, availableIdColumns = [], inheritedIdColumn = null, availableRows = [], run, busy, onRunNode, onParamsChange, onRename, onPinnedChange, onAddOutputToBoard, onInputSourceHandleChange, onClose }: Props) {
        ...
        >
          ...
          <section className="node-modal-section settings-section workflow-shell-card n8n-node-panel n8n-params-panel">
            ...
            <div className="n8n-panel-body n8n-params-body">
              <ParamEditor selectedNode={node} registry={translatedRegistry} aliases={aliases} datasets={datasets} availableColumns={availableColumns} availableIdColumns={availableIdColumns} inheritedIdColumn={inheritedIdColumn} availableRows={availableRows} onParamsChange={onParamsChange} onRename={onRename} />
