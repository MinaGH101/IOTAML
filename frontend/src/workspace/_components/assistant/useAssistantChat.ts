...
export function useAssistantChat(workflowId: number | null) {
    ...
    const { send, clear } = useAssistantActions({
        workflowId, draft, messages, blocked, setDraft, setMessages, setBusy, setClearing: setClearingHistory, setError,
    });
