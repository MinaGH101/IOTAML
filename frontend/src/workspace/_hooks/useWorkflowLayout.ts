...
export function useWorkflowLayout(paletteCollapsed: boolean, resultsCollapsed: boolean, resultsWidth: number, setResultsWidth: Dispatch<SetStateAction<number>>) {
