...
export function AppTopNav({
  ...
  const displayName = `${user.first_name || ''} ${user.last_name || ''}`.trim() || user.username || 'کاربر';
    ...
    <header className="topbar app-main-topbar iota-ai-topbar">
      <div className="iota-nav-brand-cluster">
        ...
        <button className="iota-brand-mark" type="button" onClick={onProjects} title="IOTA">
          <span className="workflow-logo-title">
            <img src="/iota.png" alt="IOTA" width={32} height={32} />
            <span className="iota-brand-name">IOTA ML</span>
          </span>
        </button>
