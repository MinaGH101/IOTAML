...
from app.nodes.io import coerce_numeric_series, ensure_df, first_upstream_df, node_label, table_output
...
class RatioCalculatorNode(BaseNode):
    ...
    def run(self, node, inputs, settings, context):
        ...
        if numerator not in df.columns or denominator not in df.columns:
            raise ValueError('Select numerator_column and denominator_column for ratio calculation.')
