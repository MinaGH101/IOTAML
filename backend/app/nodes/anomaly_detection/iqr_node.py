...
class IQROutlierNode(BaseNode):
    """Calculate Q1/Q3 IQR classes and report aligned values from another frame."""
    id = "AD-003"
    name = "IQR Anomaly Detector"
    category = "Anomaly Detection"
    description = (
        "Calculates Q1/Q3 ± kIQR classes on one dataframe and returns the "
        "matching sample values from a second dataframe."
    )
    ...
    settings_schema = [
        setting(
            ...
            help="دیتافریم متصل برای محاسبه کلاس‌های Q1/Q3.",
        ),
        setting(
            "detection_source",
        ...
        setting(
            ...
            "text",
            "1.5, 3",
            help="ضرایب مثبت برای ساخت کلاس‌های Q1/Q3 ± kIQR.",
        ),
    ...
    def run(self, node, inputs, settings, context):
        ...
        multipliers = parse_number_list(
            settings.get("iqr_multipliers") or settings.get("iqr_multiplier"),
            default=[1.5, 3.0],
        )
        ...
        display_outputs = anomaly_display_outputs(
            ...
            threshold_title="Calculated IQR Thresholds",
        )
