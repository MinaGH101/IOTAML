...
TERMINAL_STATUSES = frozenset({'succeeded', 'failed', 'cancelled', 'timed_out', 'dead_letter'})
ACTIVE_STATUSES = frozenset({'queued', 'claimed', 'running', 'retry_wait', 'cancel_requested'})
